        ...
        <li &nbsp;><b>Mobile project</b>
          <ul>
            <li>Images, theme and utils for the project: 
              <ul>
                <li>Install image plugins:
                  <ol>
                    <li>React-Native-SVG: npm i react-native-svg</li>
            ...
            <li>Fonts
              <ul>
                <li>Install Google Fonts: npm install expo-font @expo-google-fonts/roboto @expo-google-fonts/bai-jamjuree</li>
